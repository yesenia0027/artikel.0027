    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Halaman coba </div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="tables.html">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Data Kategori Soal</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="tables.html">
                    <i class="fas fa-fw fa-table"></i>
            ...
            <div id="content">
                ...
                <div class="container mt-5">
                    ...
                    <div class="alert alert-success">
                        <p><strong>Hai, <?php echo session()->get('username') ?></strong></p>
                        <p>Selamat Datang di Halaman Administrator. Anda login dengan level admin.</p>
                        </div>
                        <p>Anda dapat mengakses menu sistem ujian online melalui panel menu di sebelah kiri.</p>
                        </div>
                    </div>
                </div>
                    <!-- Content Row -->
